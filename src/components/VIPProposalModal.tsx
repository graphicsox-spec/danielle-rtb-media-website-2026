          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-mono uppercase tracking-wider text-zinc-300 font-medium mb-1.5">
                    Your Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#0E0E16] border border-white/15 focus:border-gold-accent focus:ring-1 focus:ring-gold-accent text-white text-sm outline-none transition-all placeholder-zinc-500"
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#0E0E16] border border-white/15 focus:border-gold-accent focus:ring-1 focus:ring-gold-accent text-white text-sm outline-none transition-all"
                >
              ...
              <div>
                <label className="block text-xs font-mono uppercase tracking-wider text-zinc-300 font-medium mb-2">
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`px-3.5 py-2.5 rounded-xl text-left text-xs font-medium border flex items-center justify-between transition-all cursor-pointer ${
                          isChecked
                            ? 'bg-gold-accent/15 border-gold-accent text-white shadow-sm'
                            : 'bg-[#101018] border-white/10 text-zinc-400 hover:bg-white/5'
                        }`}
                      >
                        <span>{item}</span>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-[#0E0E16] border border-white/15 focus:border-gold-accent focus:ring-1 focus:ring-gold-accent text-white text-sm outline-none transition-all resize-none placeholder-zinc-500"
                ></textarea>
              </div>
